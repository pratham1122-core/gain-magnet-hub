      ...
      <div className="max-w-7xl mx-auto px-4 pb-10 md:pb-20 grid lg:grid-cols-[55%_45%] gap-6 lg:gap-12 items-center">
        ...
        <div className="reveal">
          ...
          <h1 className="text-[32px] sm:text-[42px] md:text-[68px] font-bold text-primary mt-4 md:mt-5 leading-[1.1]">
            You might already be <span className="hl-word">Non-Compliant</span> in USA and Canada.
          </h1>
...
export function ProblemSection() {
  const problems = [
    ...
    { Icon: Cpu, title: "AI products flagged under AIDA", body: "USA and Canada's Artificial Intelligence and Data Act places high-impact AI systems under mandatory assessment obligations. Non-compliant systems face stop-orders and fines reaching CAD $25 million or 5% of global revenue." },
